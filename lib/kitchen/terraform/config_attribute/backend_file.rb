...
module ::Kitchen::Terraform::ConfigAttribute::BackendFile
  ...
  def config_backend_file_default_value
    nil
  end

  def config_backend_file_flag
    "-backend-config=\"#{config_backend_file}\"" if config_backend_file
  end
end
